...
export type ComponentSharedGalleryImagesArgs = {
...
export type ComponentSharedGalleryFiltersInput = {
  ...
  vertical?: InputMaybe<BooleanFilterInput>;
};
...
export enum Enum_Schedulerscheduler_Type {
  Archive = 'archive',
  Publish = 'publish',
}
...
export type Mutation = {
  ...
  createRecord?: Maybe<RecordEntityResponse>;
  ...
  deleteRecord?: Maybe<RecordEntityResponse>;
  ...
  updateRecord?: Maybe<RecordEntityResponse>;
...
export type Portfolio = {
  ...
  createdAt?: Maybe<Scalars['DateTime']['output']>;
  gallery: Array<Maybe<ComponentSharedGallery>>;
  label: Scalars['String']['output'];
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
  updatedAt?: Maybe<Scalars['DateTime']['output']>;
};

export type PortfolioGalleryArgs = {
  filters?: InputMaybe<ComponentSharedGalleryFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type PortfolioInput = {
  gallery?: InputMaybe<Array<InputMaybe<ComponentSharedGalleryInput>>>;
...
export type Project = {
  ...
  preview1?: Maybe<UploadFileEntityResponse>;
  preview2: UploadFileEntityResponse;
  publishedAt?: Maybe<Scalars['DateTime']['output']>;
...
export type ProjectInput = {
  ...
  gallery?: InputMaybe<Array<InputMaybe<ComponentSharedGalleryInput>>>;
  preview1?: InputMaybe<Scalars['ID']['input']>;
  preview2?: InputMaybe<Scalars['ID']['input']>;
  publishedAt?: InputMaybe<Scalars['DateTime']['input']>;
...
export type Query = {
  ...
  record?: Maybe<RecordEntityResponse>;
  records?: Maybe<RecordEntityResponseCollection>;
...
export type QueryRecordsArgs = {
  filters?: InputMaybe<RecordFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  publicationState?: InputMaybe<PublicationState>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type RecordEntity = {
  __typename?: 'RecordEntity';
  attributes?: Maybe<Record>;
  id?: Maybe<Scalars['ID']['output']>;
};

export type RecordEntityResponse = {
  __typename?: 'RecordEntityResponse';
  data?: Maybe<RecordEntity>;
};

export type RecordEntityResponseCollection = {
  __typename?: 'RecordEntityResponseCollection';
  data: Array<RecordEntity>;
  meta: ResponseCollectionMeta;
};

export type RecordFiltersInput = {
  and?: InputMaybe<Array<InputMaybe<RecordFiltersInput>>>;
  createdAt?: InputMaybe<DateTimeFilterInput>;
  email?: InputMaybe<StringFilterInput>;
  id?: InputMaybe<IdFilterInput>;
  isResolved?: InputMaybe<BooleanFilterInput>;
  message?: InputMaybe<StringFilterInput>;
  not?: InputMaybe<RecordFiltersInput>;
  or?: InputMaybe<Array<InputMaybe<RecordFiltersInput>>>;
...
export type SchedulerSchedulerInput = {
  ...
  entryId?: InputMaybe<Scalars['Long']['input']>;
